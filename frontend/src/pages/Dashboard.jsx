...
export default function Dashboard() {
    ...
    const riskLevel = summary && summary.totalInverters > 0
        ? Math.min(100, Math.round(((summary.highRisk * 15 + summary.mediumRisk * 5) / summary.totalInverters) * 100))
        : 0;
            ...
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', minHeight: 180 }}>
                        ...
                        <AlertsWidget alerts={alertStats} untrained={summary?.untrained} />
                    </div>
